Shader "VisionSimulation/Metamorphopsia"
{
    Properties
    {
        ...
        _BorderOnly("Border Only", Float) = 0
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings input) : SV_Target
            {
                ...
                if (_BorderOnly > 0.5)
                {
                    float innerEdge = smoothstep(0.17, 0.25, radialDistance);
                    float outerEdge = 1.0 - smoothstep(0.34, 0.46, radialDistance);
                    centralMask = innerEdge * outerEdge;
                }
